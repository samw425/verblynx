                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex flex-col items-end gap-2">
                        ...
                        <a
                            ...
                            className="group flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-blue-500/30 hover:bg-blue-500/10 transition-all"
                        >
                            <div className="h-1.5 w-1.5 rounded-full bg-blue-500 shadow-[0_0_5px_#3b82f6]" />
                            <span className="text-[10px] font-mono text-gray-400 group-hover:text-white tracking-widest uppercase">
